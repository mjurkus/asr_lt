...
from asr.decoder import GreedyDecoder
from asr.loader.data_loader import SpectrogramDataset, AudioDataLoader
...
def train(params):
    ...
    logger.info("Number of parameters: %d" % AsrModel.get_param_size(model))
